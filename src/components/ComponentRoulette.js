 ...
 */
export const ComponentRoulette = ({ components, spinDuration = 6000, // Default spin time: 4 seconds
finalIndex, }) => {
    ...
    return (_jsx("div", { className: "", children: _jsx("div", { className: `transition-all duration-100 ease-in-out ${transitionClasses}`, children: components[currentIndex] }) }));
};
