    ...
    awards: [
        {
            ...
            description: `Achieved Eagle Scout rank, demonstrating exceptional leadership, problem-solving, project management, and adaptability skills
through years of commitment, culminating in a successful community service project and teamwork experience.`,
    ...
    projects: [
        {
            title: "Fossil",
            description: "A client for the Mastodon microblogging platform. Won Capstone People's Choice - Computer Science award at UNT.",
        ...
        {
            title: "JWKS Server",
            description: "The mission: create a jwks server, if you choose to accept",
        ...
        {
            title: "ExtractPaper",
            description: "A preprocessor to prepare research papers for content extraction using LLMs. Was built as part of a research project at UNT ASP (AI Summer Program) to test the viability of extracting the properties of HEAs from research papers automatically.",
